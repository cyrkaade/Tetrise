...
class Matris(object):
    def __init__(self):
        ...
        self.linescleared_sound = get_sound("linescleared.wav")
...
class Game(object):
    ...
    def blit_info(self):
        ...
        scoresurf = renderpair("Счет", self.matris.score)
        levelsurf = renderpair("Уровень", self.matris.level)
        linessurf = renderpair("Линии", self.matris.lines)
        combosurf = renderpair("Комбо", "x{}".format(self.matris.combo))
...
class Menu(object):
    ...
    def main(self, screen):
        ...
        menu = kezmenu.KezMenu(
            ['Играть!', lambda: Game().main(screen)],
            ['Выйти', lambda: setattr(self, 'running', False)],
        )
        menu.position = (50, 50)
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Tetrose")
    Menu().main(screen)
